...
![强化学习](https://oss.imzhanghao.com/img/202202061348504.png)
...
![强化学习，监督学习，非监督学习](https://oss.imzhanghao.com/img/202202080608917.png)
...
### 基本元素
![强化学习的两部分和三要素](https://oss.imzhanghao.com/img/202202080614963.png)
...
![强化学习范例](https://oss.imzhanghao.com/img/202202071625676.png)
|  名称   | 对应上图中的内容 |
|  ----  | ---- |
| agent  | 鸟 |
...
### 应用场景
![强化学习应用](https://oss.imzhanghao.com/img/202202091739796.png)

**游戏**
![强化学习游戏领域的应用](https://oss.imzhanghao.com/img/202202080904190.png)
![强化学习游戏领域的应用](https://oss.imzhanghao.com/img/202202080905180.png)

**机器人**
![强化学习机器人领域的应用](https://oss.imzhanghao.com/img/202202080906945.png)
|  名称   | 对应上图中的内容 |
|  ----  | ---- |
| agent  | 策略-保持机器人平衡并行走 |
...
**推荐广告**
![强化学习在推荐中的应用](https://oss.imzhanghao.com/img/202202080906718.png)
A Reinforcement Learning Framework for Explainable Recommendation

![强化学习在广告中的应用](https://oss.imzhanghao.com/img/202202080926942.png)
...
![价值函数](https://oss.imzhanghao.com/img/202202071857303.png)
...
### 算法分类
![强化学习算法的分类](https://oss.imzhanghao.com/img/202202071919418.png)
...
![基于策略VS基于价值](https://oss.imzhanghao.com/img/202202081103918.png)
...
![Value-Based & Policy-Based & Actor Critic](https://oss.imzhanghao.com/img/202202081412652.png)
...
![Q-Learning场景范例](https://oss.imzhanghao.com/img/202202081001064.png)
假设机器人必须越过迷宫并到达终点。有地雷，机器人一次只能移动一个地砖。如果机器人踏上地雷，机器人就死了。机器人必须在尽可能短的时间内到达终点。
得分/奖励系统如下：
...
![Q-Table](https://oss.imzhanghao.com/img/202202081003156.png)

### Q函数
Q函数(Q-Function)即为上文提到的动作价值函数，他有两个输入：「状态」和「动作」。它将返回在该状态下执行该动作的未来奖励期望。
![Q函数](https://oss.imzhanghao.com/img/202202081018874.png)

我们可以把Q函数视为一个在Q-Table上滚动的读取器，用于寻找与当前状态关联的行以及与动作关联的列。它会从相匹配的单元格中返回 Q 值。这就是未来奖励的期望。
![Q函数](https://oss.imzhanghao.com/img/202202081020345.png)
...
### 算法流程
![Q-learning实现](https://oss.imzhanghao.com/img/202202081004537.png)

![Q-learning的学习过程](https://oss.imzhanghao.com/img/202202081004219.png)

**第1步：初始化Q值表**
我们将首先构建一个Q值表。有n列，其中n=操作数。有m行，其中m=状态数。我们将值初始化为0
![初始化Q表](https://oss.imzhanghao.com/img/202202081005071.png)

**步骤2和3：选择并执行操作**
这些步骤的组合在不确定的时间内完成。这意味着此步骤一直运行，直到我们停止训练，或者训练循环停止。
![选择并执行操作](https://oss.imzhanghao.com/img/202202081006986.png)
...
![权衡探索和利用](https://oss.imzhanghao.com/img/202202081037361.png)

**步骤4和5：评估**
现在我们采取了行动并观察了结果和奖励。我们需要更新功能Q（s，a）：
![更新Q表](https://oss.imzhanghao.com/img/202202081024769.png)

最后生成的Q表：
![生成的Q表](https://oss.imzhanghao.com/img/202202081011238.png)
...
![Deep Q Network](https://oss.imzhanghao.com/img/202202081012123.png)
...
### 算法流程
![DQN算法流程](https://oss.imzhanghao.com/img/202202081335646.png)
...
![Policy Gradient](https://oss.imzhanghao.com/img/202202081608856.png)
...
![REINFORCE算法流程](https://oss.imzhanghao.com/img/202202081616628.png)

### 算法流程
![REINFORCE流程图](https://oss.imzhanghao.com/img/202202081645188.png)
首先我们需要一个 policy model 来输出动作概率，输出动作概率后，我们用 sample() 函数去得到一个具体的动作，然后跟环境交互过后，我们可以得到一整个回合的数据。拿到回合数据之后，我再去执行一下 learn() 函数，在 learn() 函数里面，我就可以拿这些数据去构造损失函数，扔给这个优化器去优化，去更新我的 policy model。

## Actor Critic
演员-评论家算法(Actor-Critic)是基于策略(Policy Based)和基于价值(Value Based)相结合的方法

![演员-评论家算法](https://oss.imzhanghao.com/img/202202091122103.png)
...
### 网络结构
整体结构：
![演员-评论家网络结构](https://oss.imzhanghao.com/img/202202091127132.png)

Actor和Critic的网络结构：
![Actor Critic network ](https://oss.imzhanghao.com/img/202202091128295.png)

### 算法流程
![Actor Critic Algorithm](https://oss.imzhanghao.com/img/202202091125622.png)
...
![A3C](https://oss.imzhanghao.com/img/202202091452021.png)
...
![DDPG](https://oss.imzhanghao.com/img/202202091454219.png)
