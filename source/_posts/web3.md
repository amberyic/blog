...
![web1.0->2.0](https://imzhanghao.oss-cn-qingdao.aliyuncs.com/img/202204160723706.png)
...
**链游是什么？**
基于区块链的游戏，是指构建在区块链技术上的游戏。链游与堡垒之夜、Roblox或Minecraft等流行游戏的一个关键区别是：**游戏里的东西可以全部交易成通货然后去兑换其他游戏里的资源**。
